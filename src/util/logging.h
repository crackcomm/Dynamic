...
#ifndef DYNAMIC_LOGGING_H
#define DYNAMIC_LOGGING_H
...
static inline bool LogAcceptCategory(BCLog::LogFlags category) { return g_logger->WillLogCategory(category); }
