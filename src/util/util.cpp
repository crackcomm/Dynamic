...
const char* const DYNAMIC_CONF_FILENAME = "bitcoin.conf";
const char* const DYNAMIC_PID_FILENAME = "bitcoind.pid";
...
bool ArgsManager::ReadConfigFiles(std::string& error, bool ignore_invalid_keys)
{
    ...
    const std::string confPath = GetArg("-conf", DYNAMIC_CONF_FILENAME);
...
fs::path GetPidFile()
{
    return AbsPathForConfigVal(fs::path(gArgs.GetArg("-pid", DYNAMIC_PID_FILENAME)));
}
