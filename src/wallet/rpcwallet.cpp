    ...
    if (request.fHelp || request.params.size() > 4)
        throw std::runtime_error(
            ...
            std::to_string(nInstantSendDepth) + " confirmations for transactions locked via InstantSend\n"
                                                ...
                                                "\nExamples:\n" +
            HelpExampleCli("listreceivedbyaddress", "") + HelpExampleCli("listreceivedbyaddress", "10 false true") + HelpExampleRpc("listreceivedbyaddress", "10, false, true, true"));
    ...
    if (request.fHelp)
        throw std::runtime_error(
            ...
            CURRENCY_UNIT + ". This is negative and only available for the 'send' category of transactions.\n"
                            ...
                            "}\n"
                            "\nExamples:\n" +
            HelpExampleCli("listsinceblock", "") + HelpExampleCli("listsinceblock", "\"000000000000000bacf66f7497b7dc45ef753ee9a7d38571037cdb1a57f663ad\" 10") + HelpExampleRpc("listsinceblock", "\"000000000000000bacf66f7497b7dc45ef753ee9a7d38571037cdb1a57f663ad\", 10"));
    ...
    if (request.fHelp || request.params.size() > 3)
        throw std::runtime_error(
            ...
            CURRENCY_UNIT + "\n"
                            ...
                            "\nExamples\n" +
            HelpExampleCli("listunspent", "") + HelpExampleCli("listunspent", "10 9999999 \"[\\\"D5nRy9Tf7Zsef8gMGL2fhWA9ZslrP4K5tf\\\",\\\"D1MfcDTf7Zsef8gMGL2fhWA9ZslrP4K5tf\\\"]\"") + HelpExampleRpc("listunspent", "10, 9999999 \"[\\\"D5nRy9Tf7Zsef8gMGL2fhWA9ZslrP4K5tf\\\",\\\"D1MfcDTf7Zsef8gMGL2fhWA9ZslrP4K5tf\\\"]\""));
