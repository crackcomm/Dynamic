...
UniValue maketoken(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() < 2) {
        throw std::runtime_error("maketoken \"string\"\n"
...
UniValue gettime(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 0) {
        throw std::runtime_error("gettime\n"
...
UniValue getrawpubkey(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error("getrawpubkey \"address\"\n"
...
UniValue burndynamic(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw std::runtime_error("burndynamic \"amount\"\n"
...
UniValue sendfluidtransaction(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() != 2)
        throw std::runtime_error(
            ...
            "\nExamples:\n" +
            HelpExampleCli("sendfluidtransaction", "\"3130303030303030303030303a3a313439393336353333363a3a445148697036443655376d46335761795"
                                                   "a32747337794478737a71687779367a5a6a20494f42447a557167773\"") +
            HelpExampleRpc("sendfluidtransaction", "\"3130303030303030303030303a3a313439393336353333363a3a445148697036443655376d46335761795"
                                                   "a32747337794478737a71687779367a5a6a20494f42447a557167773\""));
    CScript finalScript;
...
{
    if (request.fHelp || request.params.size() != 2)
        throw std::runtime_error("signtoken \"address\" \"tokenkey\"\n"
                                 ...
                                 "\nExamples:\n" +
                                 HelpExampleCli("signtoken", "\"D5nRy9Tf7Zsef8gMGL2fhWA9ZslrP4K5tf\" "
                                                             "\"3130303030303030303030303a3a313439393336353333363a3a445148697036443655376d4"
                                                             "6335761795a32747337794478737a71687779367a5a6a20494f42447a557167773\"") +
                                 HelpExampleRpc("signtoken", "\"D5nRy9Tf7Zsef8gMGL2fhWA9ZslrP4K5tf\" "
                                                             "\"3130303030303030303030303a3a313439393336353333363a3a445148697036443655376d4"
                                                             "6335761795a32747337794478737a71687779367a5a6a20494f42447a557167773\""));
    std::string result;
...
{
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error("verifyquorum \"tokenkey\"\n"
                                 "\nVerify if the token provided has required quorum\n"
                                 "\nArguments:\n"
                                 "1. \"tokenkey\"         (string, required) The token which has to be initially signed\n"
                                 "\nExamples:\n" +
                                 HelpExampleCli("verifyquorum", "\"3130303030303030303030303a3a313439393336353333363a3a44514869703644365537"
                                                                "6d46335761795a32747337794478737a71687779367a5a6a20494f42447a557167773\"") +
                                 HelpExampleRpc("verifyquorum", "\"3130303030303030303030303a3a313439393336353333363a3a44514869703644365537"
                                                                "6d46335761795a32747337794478737a71687779367a5a6a20494f42447a557167773\""));
    std::string message;
...
{
    if (request.fHelp || request.params.size() != 2)
        throw std::runtime_error("consenttoken \"address\" \"tokenkey\"\n"
                                 ...
                                 "\nExamples:\n" +
                                 HelpExampleCli("consenttoken", "\"D5nRy9Tf7Zsef8gMGL2fhWA9ZslrP4K5tf\" "
                                                                "\"3130303030303030303030303a3a313439393336353333363a3a44514869703644365537"
                                                                "6d46335761795a32747337794478737a71687779367a5a6a20494f42447a557167773\"") +
                                 HelpExampleRpc("consenttoken", "\"D5nRy9Tf7Zsef8gMGL2fhWA9ZslrP4K5tf\" "
                                                                "\"3130303030303030303030303a3a313439393336353333363a3a44514869703644365537"
                                                                "6d46335761795a32747337794478737a71687779367a5a6a20494f42447a557167773\""));
    std::string result;
...
{
    if (request.fHelp || request.params.size() != 0)
        throw std::runtime_error("getfluidhistoryraw\n"
...
{
    if (request.fHelp || request.params.size() != 0)
        throw std::runtime_error("getfluidhistory\n"
...
{
    if (request.fHelp || request.params.size() != 0)
        throw std::runtime_error("getfluidsovereigns\n"
