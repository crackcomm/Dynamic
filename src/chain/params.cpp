// C / hash.ht (c) 2009-2018 Satoshi Nakamoto
    ...
    const CAmount& genesisReward)
{
    ...
    txNew.vin.resize(1);
    txNew.vout.resize(1);
    txNew.vin[0].scriptSig = CScript() << 1512926956 << CScriptNum(4)
...
static void MineGenesis(CBlockHeader& genesisBlock, const uint256& powLimit, bool noProduction)
{
    ...
    while (newhash > hashTarget) {
        ...
        if ((genesisBlock.nNonce & 0xfff) == 0)
            printf("nonce %08X: hash = %s (target = %s)\n", genesisBlock.nNonce, newhash.ToString().c_str(), hashTarget.ToString().c_str());
 ...
 * database.
 *
 * CBlock(hash=00000ffd590b14, ver=1, hashPrevBlock=00000000000000, hashMerkleRoot=e0028e, nTime=1390095618, nBits=1e0ffff0,
 * nNonce=28917698, vtx=1) CTransaction(hash=e0028e, ver=1, vin.size=1, vout.size=1, nLockTime=0) CTxIn(COutPoint(000000, -1), coinbase
...
public:
    CMainParams()
    {
        ...
        vAlertPubKey = ParseHex("04bf1391ff0c61a5d9a02cd2e997b707ced89bb48514e26d89f2464c98295ffef3f587263c94e6024d4e455802ad73e1e9694f3e48"
                                "2ff6e074736cb2327f9cd3e7");
        ...
        checkpointData =
            (CCheckpointData){boost::assign::map_list_of(0, uint256S("0x00000e140b0c3028f898431890e9dea79ae6ca537ac9362c65b45325db712de2"))(
...
public:
    CTestNetParams()
    {
        ...
        vAlertPubKey = ParseHex("043d9e8440ea8fe66b0c2639f0a0931c9d7c41132ec9ee04cdf5d9e88ada2c2df52d93a0c1983958d3aea56df9fb3d1a61ca4eb6f7"
                                "2c27456fc313be80cdc70032");
        ...
        vSporkAddresses = {
            "DGjj2YB4c988rpgVQbhkLnwthRDbmZF2ie"}; // Must have this converted to an address
                                                   // "04d7e3d70462588ccde4cf2e4e8f29925395ee3ae2ded5244056cc895aab4c158986c702b2ef9665bf8f34450e153a649bdff3b3c784ec707fb637e1ba5ae100f5";
        nMinSporkKeys = 1;
...
public:
    CRegTestParams()
    {
        ...
        vAlertPubKey = ParseHex("04e8118b469667861157f3b2b28056ae92581ce61ce2db80d04a701f5ec5391b751e6136bafdcca7b8d0b564a5afce213e8069bdd1"
                                "d17131f61d116b73dbf7e2d6");
