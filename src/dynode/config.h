...
public:
    ...
    public:
        CDynodeEntry(const std::string& alias,
            const std::string& ip,
        ...
        void setOutputIndex(const std::string& outputIndex) { this->outputIndex = outputIndex; }

        const std::string& getPrivKey() const { return privKey; }

        void setPrivKey(const std::string& privKey) { this->privKey = privKey; }

        const std::string& getTxHash() const { return txHash; }

        void setTxHash(const std::string& txHash) { this->txHash = txHash; }
    ...
    CDynodeConfig() { entries = std::vector<CDynodeEntry>(); }
    ...
    std::vector<CDynodeEntry>& getEntries() { return entries; }

    int getCount() { return (int)entries.size(); }
