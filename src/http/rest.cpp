// C / strencodings.h09-2010 Satoshi Nakamoto
...
static bool rest_block_notxdetails(HTTPRequest* req, const std::string& strURIPart) { return rest_block(req, strURIPart, false); }
...
static bool rest_getutxos(HTTPRequest* req, const std::string& strURIPart)
{
    ...
    if (vOutPoints.size() > MAX_GETUTXOS_OUTPOINTS)
        return RESTERR(req, HTTP_BAD_REQUEST,
            tfm::format("Error: max outpoints exceeded (max: %d, tried: %d)", MAX_GETUTXOS_OUTPOINTS, vOutPoints.size()));
