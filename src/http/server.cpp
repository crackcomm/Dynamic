// Cop / compat.h) 2015 The Bitcoin Core developers
        ...
        for (std::string strAllow : vAllow) {
            ...
            if (!subnet.IsValid()) {
                uiInterface.ThreadSafeMessageBox(
                    tfm::format("Invalid -rpcallowip subnet specification: %s. Valid are a single IP (e.g. 1.2.3.4), a network/netmask (e.g. 1.2.3.4/255.255.255.0) or a network/CIDR (e.g. 1.2.3.4/24).", strAllow),
